(function webpackUniversalModuleDefinition(root, factory) {
            ...
            /***/ 482: /***/ function (
                ...
                class DateRangePicker {
                    ...
                    constructor(element, options = {}) {
                        ...
                        const changeDateListener = onChangeDate.bind(
                            null,
                            this
                        );
                ...
                function processOptions(options, datepicker) {
                    ...
                    if (inOpts.format) {
                        ...
                        const validFormatString =
                            date_format /* reFormatTokens.test */.CL.test(
                                inOpts.format
                            );
                    ...
                    if (inOpts.datesDisabled) {
                        config.datesDisabled = inOpts.datesDisabled.reduce(
                            (dates, dt) => {
                                const date = (0,
                                date_format /* parseDate */.sG)(
                                    dt,
                                    format,
                                    locale
                                );
                                return date !== undefined
                                    ? (0, utils /* pushUnique */.$C)(
                                          dates,
                                          date
                                      )
                                    : dates;
  ...
  utils /* createTagRepeat */.em)("span", 42, {
      class: "block flex-1 leading-9 border-0 rounded-lg cursor-default text-center text-gray-900 font-semibold text-sm h-6 leading-6 text-sm font-medium text-gray-500 dark:text-gray-400",
                ...
                /* harmony default export */ var templates_daysTemplate =
                    daysTemplate; // CONCATENATED MODULE: ./node_modules/flowbite-datepicker/js/picker/templates/calendarWeeksTemplate.js
  ...
  <div class="weeks">${(0, utils /* createTagRepeat */.em)("span", 6, {
      class: "week block flex-1 leading-9 border-0 rounded-lg cursor-default text-center text-gray-900 font-semibold text-sm",
                ...
                class DaysView extends View {
                        ...
                        if (updateDOW) {
                            Array.from(this.dow.children).forEach(
                                (el, index) => {
                                    ...
                                    el.className =
                                        this.daysOfWeekDisabled.includes(dow)
                    ...
                    render() {
                        ...
                        Array.from(this.grid.children).forEach((el, index) => {
                            ...
                            const current = (0, lib_date /* addDays */.E4)(
                                this.start,
                                index
                            );
                    ...
                    refreshFocus() {
                        const index = Math.round(
                            (this.focused - this.start) / 86400000
                        );
                    ...
                    updateSelection() {
                        ...
                        this.selected = dates.reduce((years, timeValue) => {
                            return (0, utils /* pushUnique */.$C)(
                                years,
                                (0, lib_date /* startOfYearPeriod */.ak)(
                                    timeValue,
                                    this.step
                                )
                            );
                ...
                function onClickView(datepicker, ev) {
                    const target = (0,
                    lib_event /* findElementInEventPath */.He)(
                        ev,
                        ".datepicker-cell"
                    );
                ...
                function onClickPicker(datepicker) {
                    if (
                        !datepicker.inline &&
                        !datepicker.config.disableTouchKeyboard
                    ) {
                ...
                function processPickerOptions(picker, options) {
                    ...
                    if (options.locale) {
                        picker.controls.todayBtn.textContent =
                            options.locale.today;
                        picker.controls.clearBtn.textContent =
                    ...
                    if (
                        ...
                        picker.controls.todayBtn.disabled = !(0,
                        utils /* isInRange */.mh)(
                            (0, lib_date /* today */.Lg)(),
                            minDate,
                            maxDate
                ...
                class Picker {
                    constructor(datepicker) {
                        ...
                        const elementClass = datepicker.inline
                            ? "inline"
                            : "dropdown";
                        ...
                        this.currentView =
                            this.views[datepicker.config.startView];
                    ...
                    show() {
                        ...
                        if (!datepicker.inline) {
                            ...
                            const inputDirection = getTextDirection(
                    ...
                    update() {
                        const newViewDate = computeResetViewDate(
                            this.datepicker
                        );
                        this._renderMethod = setViewDate(this, newViewDate)
                            ? "render"
                ...
                function moveByArrowKey(datepicker, ev, direction, vertical) {
                    ...
                    switch (currentView.id) {
                        case 0:
                            ...
                            testFn = (date) =>
                                currentView.disabled.includes(date);
                            break;
                        case 1:
                ...
                function processInputDates(
                    ...
                    const rangeEnd =
                        rangepicker &&
                        datepicker === rangepicker.datepickers[1];
                ...
                class Datepicker {
                    ...
                    constructor(
                        ...
                        if (inline) {
                            ...
                            const onMousedownDocument = onClickOutside.bind(
                                null,
                                this
                            );
                            const listeners = [
                            ...
                            (0, lib_event /* registerListeners */.cF)(
                                this,
                                listeners
                            );
                        }
            ...
            /***/ 963: /***/ function (
                ...
                function parseDate(dateStr, format, locale) {
                    if (
                        ...
                        const date = (0,
                        _date_js__WEBPACK_IMPORTED_MODULE_0__ /* .stripTime */.xR)(
                            dateStr
                        );
                    ...
                    if (dateStr === "today") {
                        return (0,
                        _date_js__WEBPACK_IMPORTED_MODULE_0__ /* .today */.Lg)();
                    }
            ...
            /***/ 560: /***/ function (
                ...
                function getWeek(date) {
                    ...
                    return (
                        Math.round((thuOfTheWeek - firstThu) / 604800000) + 1
                    );
                }
        ...
        !(function () {
            ...
            var getDatepickerOptions = function getDatepickerOptions(
                datepickerEl
            ) {
                var buttons = datepickerEl.hasAttribute("datepicker-buttons");
                var autohide = datepickerEl.hasAttribute("datepicker-autohide");
                var format = datepickerEl.hasAttribute("datepicker-format");
                var orientation = datepickerEl.hasAttribute(
                ...
                if (format) {
                    options.format =
                        datepickerEl.getAttribute("datepicker-format");
                }
                if (orientation) {
                ...
                if (title) {
                    options.title =
                        datepickerEl.getAttribute("datepicker-title");
                }
                return options;
            };
            ...
            var events = new _dom_events__WEBPACK_IMPORTED_MODULE_2__[
                "default"
            ]("DOMContentLoaded", [initDatepickers]);
            events.init();
        })();
