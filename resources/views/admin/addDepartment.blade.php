        ...
        <div class="w-1/2 mx-auto border p-5 rounded-md my-5">
          ...
          <form method="POST" action="/admin/add-department">
            ...
            <div class="relative z-0 w-full mb-6 group">
              ...
              <label for="department" class="peer-focus:font-medium absolute text-sm text-gray-500 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:left-0 peer-focus:text-blue-600 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Enter Department Name</label>
            </div>
