        ...
        <div class="w-1/2 mx-auto border p-5 rounded-md my-5">
          ...
          <form method="POST" action="/admin/add-category">
            ...
            <div class="grid grid-cols-3">
              ...
              <div class="relative z-0 w-11/12 mb-6 group col-span-2">
                ...
                <label for="category" class="peer-focus:font-medium absolute text-sm text-gray-500 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:left-0 peer-focus:text-blue-600 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Enter Category</label>
              </div>
              <div class="relative z-0 w-full mb-6 group">
                <input type="number" name="deweyDecimal" id="deweyDecimal" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
                <label for="deweyDecimal" class="peer-focus:font-medium absolute text-sm text-gray-500 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:left-0 peer-focus:text-blue-600 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Enter Dewey Decimal</label>
              </div>
            </div>
