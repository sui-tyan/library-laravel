    ...
    <main>
      <div class="py-6 px-4">
        ...
        <div class="flex p-4 mb-4 text-sm text-green-800 rounded-lg bg-green-50 dark:bg-gray-800 dark:text-green-400" role="alert">
          ...
          <div>
            <span class="font-medium">{{Session::get('registered')}}</span>
          </div>
        </div>
        ...
        <div class="w-1/2 mx-auto border p-5 rounded-md my-5">
          <form method="POST" action="/addStudent">
            ...
            <div class="relative z-0 w-full mb-6 group">
              ...
              <select id="underline_select" name="department" class="block py-2.5 px-0 w-full text-sm text-gray-500 bg-transparent border-0 border-b-2 border-gray-200 appearance-none focus:outline-none focus:ring-0 focus:border-gray-200 peer">
