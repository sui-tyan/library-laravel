        ...
        <div class="w-1/2 mx-auto border p-5 rounded-md my-5">
          ...
          <form method="POST" action="/admin/update-{{$link}}">
            ...
            <div class="relative z-0 w-full mb-6 group">
              <input type="text" name="isbn" value="{{$book->isbn}}" id="isbn" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
            ...
            <div class="relative z-0 w-full mb-6 group">
              <input type="text" name="description" value="{{$book->description}}" id="description" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
            ...
            <div class="grid grid-cols-2">
              <div class="relative z-0 w-11/12 mb-6 group">
                <input type="text" name="author" value="{{$book->author}}" id="author" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
              ...
              <div class="relative z-0 w-full mb-6 group">
                <input type="text" name="publisher" value="{{$book->publisher}}" id="publisher" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
            ...
            <div class="grid grid-cols-2 gap-6">
              <div class="relative z-0 w-full mb-6 group">
                <input type="number" name="price" value="{{$book->price}}" id="price" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
              ...
              <div class="relative z-0 w-full mb-6 group">
                <input type="number" name="quantity" value="{{$book->quantity}}" id="quantity" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
                <label for="quantity" class="peer-focus:font-medium absolute text-sm text-gray-500 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:left-0 peer-focus:text-blue-600 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Enter Quantity</label>
              </div>
            </div>
            ...
            <div class="grid grid-cols-2">
              ...
              <div class="relative z-0 w-full mb-6 group">
                ...
                <select id="underline_select" name="categories" class="block py-2.5 px-0 w-full text-sm text-gray-500 bg-transparent border-0 border-b-2 border-gray-200 appearance-none focus:outline-none focus:ring-0 focus:border-gray-200 peer">
                  <option selected value="{{$book->categories}}">{{$book->categories}}</option>
            ...
            <div class="grid grid-cols-2">
              ...
              <div class="relative z-0 w-11/12 mb-6 group">
                ...
                <select id="underline_select" name="type" class="block py-2.5 px-0 w-full text-sm text-gray-500 bg-transparent border-0 border-b-2 border-gray-200 appearance-none focus:outline-none focus:ring-0 focus:border-gray-200 peer">
                  <option selected value="{{$book->type}}">{{$book->type}}</option>
              ...
              <div class="relative z-0 w-full mb-6 group">
                ...
                <select id="underline_select" name="remarks" class="block py-2.5 px-0 w-full text-sm text-gray-500 bg-transparent border-0 border-b-2 border-gray-200 appearance-none focus:outline-none focus:ring-0 focus:border-gray-200 peer">
                  <option selected value="{{$book->remarks}}">{{$book->remarks}}</option>
