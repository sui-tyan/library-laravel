      ...
      <div class="flex-1 flex flex-col pt-5 pb-4 overflow-y-auto">
        <div class="flex-1 px-3 bg-white divide-y space-y-1">
          <ul class="space-y-2 pb-2">
            ...
            <li>
              <a href="/admin/users" class="text-base text-gray-900 font-normal rounded-lg hover:bg-gray-100 flex items-center p-2 group ">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
          ...
          <div class="bg-white shadow rounded-lg p-4 sm:p-6 xl:p-8 ">
            <div class="flex items-center">
              <div class="flex-shrink-0">
                <span class="text-base sm:text-lg leading-none font-bold text-gray-900">Borrower</span>
                <h3 class="text-base font-normal text-gray-500">Borrower list</h3>
              </div>
        ...
        <div class="w-full ">
          <div class="bg-white shadow rounded-lg p-4 sm:p-6 xl:p-8 ">
            ...
            <div class="mb-4 flex items-center justify-between">
              <div>
                <h3 class="text-xl font-bold text-gray-900 mb-2">Available Books</h3>
              </div>
              <div class="flex-shrink-0">
