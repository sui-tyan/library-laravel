      ...
      <div class="py-6 px-4">
        <div class="mb-4 w-full grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4">
          <div class="bg-white shadow rounded-lg p-4 sm:p-6 xl:p-8 ">
            <div class="flex items-center">
              <div class="flex-shrink-0">
                <span class="text-2xl sm:text-3xl leading-none font-bold text-gray-900">Add Book</span>
                <h3 class="text-base font-normal text-gray-500">(Books, Thesis, Journals)</h3>
              </div>
              <div class="ml-5 w-0 flex items-center justify-end flex-1 text-base font-bold">
          ...
          <div class="bg-white shadow rounded-lg p-4 sm:p-6 xl:p-8 ">
            <div class="flex items-center">
              <div class="flex-shrink-0">
                <span class="text-2xl sm:text-3xl leading-none font-bold text-gray-900">Add Category</span>
                <h3 class="text-base font-normal text-gray-500">(Ex: Science, Literature)</h3>
              </div>
              <div class="ml-5 w-0 flex items-center justify-end flex-1 text-base font-bold">
          ...
          <div class="bg-white shadow rounded-lg p-4 sm:p-6 xl:p-8 ">
            <div class="flex items-center">
              <div class="flex-shrink-0">
                <span class="text-2xl sm:text-3xl leading-none font-bold text-gray-900">Add Department</span>
                <h3 class="text-base font-normal text-gray-500">(Ex: CITE, CTE)</h3>
              </div>
              <div class="ml-5 w-0 flex items-center justify-end flex-1 text-base font-bold">
          ...
          <div class="bg-white shadow rounded-lg p-4 sm:p-6 xl:p-8 ">
            <div class="flex items-center">
              <div class="flex-shrink-0">
                <span class="text-2xl sm:text-3xl leading-none font-bold text-gray-900">Create Account</span>
                <h3 class="text-base font-normal text-gray-500">(Student Account)</h3>
              </div>
              <div class="ml-5 w-0 flex items-center justify-end flex-1 text-base font-bold">
          ...
          <div class="bg-white shadow rounded-lg p-4 sm:p-6 xl:p-8 ">
            <div class="flex items-center">
              <div class="flex-shrink-0">
                <span class="text-2xl sm:text-3xl leading-none font-bold text-gray-900">Create Staff</span>
                <h3 class="text-base font-normal text-gray-500">(Librarian and Admin Account)</h3>
              </div>
              <div class="ml-5 w-0 flex items-center justify-end flex-1 text-base font-bold">
