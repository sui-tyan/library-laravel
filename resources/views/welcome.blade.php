...
<!-- Hero section -->
<section class="bg-white bg-no-repeat h-[75vh] bg-cover" style="background-image: url({{url('/images/UPang.jpg')}})">
...
<section class="bg-white h-[100vh] my-16">
    ...
    <div class="container">
        <div class="flex flex-wrap gap-5 justify-center items-center text-center">
            <div class="md:w-1/2 pr-4 pl-4 lg:w-1/4 flex justify-center mb-5 lg:mb-0"
