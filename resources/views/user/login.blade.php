...
<div class="w-1/2 mx-auto border p-5 rounded-md my-5">
  ...
  <form method="POST" action="/authenticate">
    ...
    <div class="relative z-0 w-full mb-6 group">
      <input type="text" name="studentID" id="studentId" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:border-[#19b032] peer" placeholder=" " required />
